...
void add_vars(t_vars *vars,t_texture_name *texture_name, t_map_list *map_list)
{
    ...
    vars->wall[0].addr = mlx_get_data_addr(vars->wall[0].img, &(vars->wall[0].bits_per_pixel),
			&(vars->wall[0].size_len), &(vars->wall[0].endian));
	vars->wall[1].addr = mlx_get_data_addr(vars->wall[1].img, &(vars->wall[1].bits_per_pixel),
			&(vars->wall[1].size_len), &(vars->wall[1].endian));
	vars->wall[2].addr = mlx_get_data_addr(vars->wall[2].img, &(vars->wall[2].bits_per_pixel),
			&(vars->wall[2].size_len), &(vars->wall[2].endian));
	vars->wall[3].addr = mlx_get_data_addr(vars->wall[3].img, &(vars->wall[3].bits_per_pixel),
